...
public class ConnectionHandler implements Runnable
{
    ...
    private static final int unsettingIdOfPeer = minusone;
    ...
    public ConnectionHandler(int regionalIdOfPeer, Socket thesocket, FileManager managerOfFile, PeerManager managerOfPeer) throws IOException
    {
        ...
        stackInt.push(minusone);
        this(regionalIdOfPeer, incorrect, minusone, thesocket, managerOfFile, managerOfPeer);
    }
